...
<section id="team">
  <h4>Наша команда</h4>
  <ul>
    <li>Алексей «Биткоин» Безруких – гуру безграничного майнинга.</li>
    <li>Макс «КриптоКот» Катаван – повелитель цифровых котировок.</li>
    <li>Андрей «Эфирыч» Володин – архитектор умных контрактов.</li>
    <li>Семён «Сатоши» Сапрыкин – мастер децентрализации и тайн блокчейна.</li>
  </ul>
</section>
